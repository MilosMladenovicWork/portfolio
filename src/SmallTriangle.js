...
function SmallTriangle(props){
  return(
    <motion.svg drag={true} dragConstraints={props.appContainer} animate={{rotate:[0, 10, -10, 0], translateY:[0, 20, -20, 0]}} transition={{duration:7.5,ease: 'easeInOut', loop:Infinity}} xmlns="http://www.w3.org/2000/svg" className='small-triangle' viewBox="0 0 172.664 189.664">
